...
@section('title', 'Edit Profil Penjual')

@section('content')
<div id="mainContentWrapper" class="flex items-center justify-center min-h-screen w-full overflow-hidden pt-16">
    <div class="border rounded-lg p-4 sm:p-6 bg-white space-y-4 w-full max-w-md">
        ...
        <form id="formPenjual" class="space-y-4">
            <div>
                ...
                <input id="name" name="name" type="text" value="Budi Santoso"
            ...
            <div>
                ...
                <input id="email" name="email" type="email" value="budi@swarnakarya.com"
                    class="mt-1 w-full text-sm bg-gray-100 border border-gray-300 rounded-md px-4 py-2 shadow-sm focus:outline-none focus:ring-[#69553E] focus:border-[#69553E]"
                    disabled>
            </div>
            ...
            <div>
                ...
                <input id="no_telepon" name="no_telepon" type="text" value="+62 81234567890"
                    class="mt-1 w-full text-sm bg-gray-100 border border-gray-300 rounded-md px-4 py-2 shadow-sm focus:outline-none focus:ring-[#69553E] focus:border-[#69553E]"
                    disabled>
            </div>
