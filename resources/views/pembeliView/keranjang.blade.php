...
<!-- Isi Keranjang (Cart Items) -->
<!-- MENGHAPUS ml-64. Konten akan mengisi penuh ruang sisa. -->
<div id="cart" class="px-4 pt-[7rem] pb-36 space-y-4 bg-[#fdfbf8] min-h-screen"> 
    <!-- Items akan di-render di sini -->
</div>

<!-- Footer/Bottom Bar (Checkout Summary) (FIXED) -->
<!-- Mempertahankan ml-64 agar footer tidak berada di bawah sidebar. -->
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function renderCart() {
        ...
        cart.forEach(item => {
            ...
            // 'w-full' memastikan kartu mengisi lebar container.
            ...
            itemDiv.innerHTML = `
                ...
                <!-- Gambar Produk (Ukuran 96px x 96px) -->
                ...
                <!-- Konten Produk (Nama, Harga, Qty, Hapus) -->
                <div class="flex-1 min-w-0 flex items-start">
                    ...
                    <!-- Qty dan Hapus (Menggunakan ml-auto untuk menempatkan di sebelah kanan) -->
    ...
    checkoutBtn.addEventListener('click', function (e) {
        ...
        const itemsToRemoveIds = selectedItems.map(i => i.id);
        
        checkoutItemsInput.value = JSON.stringify(selectedItems);
        
        cart = cart.filter(item => !itemsToRemoveIds.includes(item.id));
        localStorage.setItem('cartItems', JSON.stringify(cart));
